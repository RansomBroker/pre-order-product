            ...
            if(currSeat == 0) {
                ...
                swal.fire({
                    ...
                    if(result.isConfirmed) {
                        ...
                        if (seatAvail) {
                            swal.fire({
                                iconHtml: '<img src="<?php echo e(asset('assets/img/email_logo.png')); ?>" width="100">',
                                width: "50%",
                                ...
                                if(result.isConfirmed) {
                                    window.location.replace("jac2022.com");
                                }
                            })
                        } else {
                            swal.fire({
...
<?php echo $__env->make('index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/jafra-seat/resources/views/home.blade.php ENDPATH**/ ?>